...
sudo wget https://raw.githubusercontent.com/ShaheenHossain/installScript_01/inclass1634/eagle1634_install.sh
```
...
```
sudo chmod +x eagle1634_install.sh

sudo ./eagle1634_install.sh
