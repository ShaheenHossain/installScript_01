...
## https://github.com/swiss/swiss/wiki/Wkhtmltopdf ):
...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE1661' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/swisscrm_swiss_16ent_02  $OE_HOME_EXT/
...
EOF
  ...
  sudo mv ~/swiss /etc/nginx/sites-available/$WEBSITE_NAME
