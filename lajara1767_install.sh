...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'LAJARA1767' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/eagle1767_temp_lajara $OE_HOME_EXT/
